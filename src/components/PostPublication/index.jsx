import "./style.css";
import publicationItem from "../../assets/images/cover.png";
  ...
  return (
    <div className="post__publication">
      <div className="publication__box">
        <div
          className="publication__box___item"
          style={{
        ...
        <p className="publication__box___text">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Dignissim
          enim sit amet venenatis urna. Id ornare arcu odio ut sem. Interdum
          velit euismod in pellentesque massa placerat duis. Amet purus gravida
          quis blandit. Faucibus turpis in eu mi bibendum. Maecenas sed enim ut
          sem viverra aliquet. Fermentum dui faucibus in ornare quam. Euismod
